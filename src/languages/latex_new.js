...
function latex(hljs) {
  ...
  const ARITHMETIC_CS = [
    ...
    { className: "number", begin: /\bto?[0-9]+(pt|pc|bp|in|cm|mm|dd|cc|sp|ex|em|mu|fi[l]{1,3})+\b/ },
    { className: "number", begin: /\bto?[0-9]+\.[0-9]+(pt|pc|bp|in|cm|mm|dd|cc|sp|ex|em|mu|fi[l]{1,3})+\b/ },
    { className: "number", begin: /\bto?\.[0-9]+(pt|pc|bp|in|cm|mm|dd|cc|sp|ex|em|mu|fi[l]{1,3})+\b/ },
    // unicode defs
  ...
  const INTERNAL_QUANTITY = [
    ...
    {
      className: "type",
      begin: /\\(box|counter|count|count?(?:[0-9]{0,3})|dimen|muskip|skip|toks)\b/
    },
    {
      className: "type",
